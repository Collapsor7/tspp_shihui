...
int events[4] = {PAPI_L1_DCM, PAPI_L1_ICM, PAPI_L1_TCM, PAPI_TOT_INS}; 
const char* event_names[4] = {"PAPI_L1_DCM", "PAPI_L1_ICM", "PAPI_L1_TCM", "PAPI_TOT_INS"}; 
...
// 清零 values 数组 
memset(values, 0, sizeof(long long) * 4); 
...
// 存储各测试的算法性能结果 
long long alg1_values[N_TESTS][4]; 
long long alg2_values[N_TESTS][4]; 
...
printf("Alg1 - PAPI_L1_DCM: %lld, PAPI_L1_ICM: %lld, PAPI_L1_TCM: %lld, PAPI_TOT_INS: %lld\n", 
alg1_values[n_test][0], alg1_values[n_test][1], alg1_values[n_test][2], alg1_values[n_test][3]); 
...
printf("Alg2 - PAPI_L1_DCM: %lld, PAPI_L1_ICM: %lld, PAPI_L1_TCM: %lld, PAPI_TOT_INS: %lld\n", 
alg2_values[n_test][0], alg2_values[n_test][1], alg2_values[n_test][2], alg2_values[n_test][3]); 
